const { useState, useEffect, useRef, useCallback } = React;
        ...
        const axios = axios;
        const API_KEY = '63af465dcba199553722b65b2003a504';
                    ...
                    <nav className="container mx-auto px-4 py-4 relative">
                        <div className="flex justify-between items-center">
                            <Link to="/" className="flex items-center space-x-2">
                                <span className="text-3xl md:text-4xl font-bold gradient-text tracking-tight animate-float">Sapar Films</span>
                            ...
                            <div className="hidden md:flex items-center space-x-6">
                                <SearchBar />
                                <Link to="/movies" className="text-gray-300 hover:text-white transition-colors">Кинолар</Link>
                                <Link to="/tv" className="text-gray-300 hover:text-white transition-colors">TV</Link>
                                <Link to="/watchlist" className="text-gray-300 hover:text-white transition-colors">Тізімдер</Link>
                                <Link to="/continue-watching" className="text-gray-300 hover:text-white transition-colors">Жалғастыру</Link>
                                <InstallPWA />
                        ...
                        <div className={`md:hidden absolute top-full left-0 right-0 bg-black/95 backdrop-blur-lg transition-all duration-300 ${isMenuOpen ? 'max-h-screen py-4' : 'max-h-0 overflow-hidden'}`}>
                            <div className="flex flex-col space-y-4 px-4">
                                ...
                                <nav className="flex flex-col space-y-2">
                                    <Link to="/" className="hover:text-[#4facfe] transition-colors py-2" onClick={() => setIsMenuOpen(false)}>Бастапқы бет</Link>
                                    <Link to="/movies" className="hover:text-[#4facfe] transition-colors py-2" onClick={() => setIsMenuOpen(false)}>Кинолар</Link>
                                    <Link to="/tv" className="hover:text-[#4facfe] transition-colors py-2" onClick={() => setIsMenuOpen(false)}>TV</Link>
                                    <Link to="/watchlist" className="hover:text-[#4facfe] transition-colors py-2" onClick={() => setIsMenuOpen(false)}>Тізімдер</Link>
        ...
        function Home() {
            ...
            const sectionTitles = {
                trendingMoviesWeek: "Осы аптада танымал фильмдер",
                trendingTVWeek: "Осы аптадағы танымал телешоулар",
                trendingMoviesDay: "Бүгінгі тренд фильмдер",
                trendingTVDay: "Бүгінгі трендті телешоулар",
                topRatedMovies: "Ең жоғары бағаланған фильмдер",
                topRatedTV: "Жоғары рейтингті телешоулар",
                upcoming: "Алдағы фильмдер",
                popularMovies: "Танымал фильмдер",
                popularTV: "Танымал телешоулар",
                nowPlaying: "Қазір ойнату",
                airingToday: "Бүгін эфирге шығатын телешоулар",
                onTheAir: "Қазіргі уақытта телешоулар көрсетілуде",
                action: "Экшн фильмдері",
                comedy: "Комедиялық фильмдер",
                horror: "Қорқынышты фильмдер",
                documentary: "Деректі фильмдер"
            };
                    ...
                    <div className="container mx-auto px-4">
                        <div className="flex flex-wrap justify-between">
                            <div className="w-full md:w-1/3 mb-8 md:mb-0">
                                <h3 className="text-3xl font-bold gradient-text mb-4">Sapar Films</h3>
                                <p className="text-gray-400">Тегін және ыңғайлы онлайн кинотеатр</p>
                            </div>
                            <div className="w-full md:w-1/3 mb-8 md:mb-0">
                                <h4 className="text-xl font-semibold mb-4">Навигация</h4>
                                <ul className="space-y-2">
                                    <li><Link to="/" className="text-gray-400 hover:text-[#4facfe] transition duration-300">Бастапқы бет</Link></li>
                                    <li><Link to="/movies" className="text-gray-400 hover:text-[#4facfe] transition duration-300">Кинолар</Link></li>
                                    <li><Link to="/tv" className="text-gray-400 hover:text-[#4facfe] transition duration-300">TV</Link></li>
                                </ul>
                            </div>
                            <div className="w-full md:w-1/3">
                        ...
                        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-500">
                            <p>&copy; 2024 Sapar Films. All rights reserved.</p>
                        </div>
                    </div>
                </footer>
            );
        ...
        function SearchBar() {
            ...
            const searc = useRef(null);

            return (
                <div ref={searc} className="relative w-full md:w-auto z-50">
                    <div className="premium-glass rounded-full overflow-hidden flex items-center">
                        <input
                            ...
                            placeholder="Кинолар немесе Телешоу"
